...
public class ManageEventEmployeeJPanel extends javax.swing.JPanel {
    ...
    ManageEventEmployeeJPanel(JPanel userProcessContainer, OrganizationDirectory directory, EventOrganisation eventOrganisation) {
        initComponents();
    ...
    public void populateOrganizationEmpComboBox(){
        ...
        for (SubOrganization subOrganization : eventOrganisation.getEventSubOrganizationDirectory().getOrganizationList()) {
            organizationEmpJComboBox.addItem(subOrganization);
        }
    }
    
    
    private void populateTable(SubOrganization organization){
    ...
    private void initComponents() {
        ...
        setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 204), 10, true));
    ...
    private void organizationJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_organizationJComboBoxActionPerformed
        SubOrganization subOrganization = (SubOrganization) organizationJComboBox.getSelectedItem();
        if (subOrganization != null){
            populateTable(subOrganization);
        }
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if (nameJTextField.getText().equals("")) {
            ...
            SubOrganization organization = (SubOrganization) organizationEmpJComboBox.getSelectedItem();
